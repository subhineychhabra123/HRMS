...
namespace EMPMGMT.Repository
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual ObjectResult<SSP_GetActionItemsFromActionListId_Result> SSP_GetActionItemsFromActionListId(Nullable<int> actionListId, Nullable<bool> onTime, Nullable<bool> overDue, Nullable<bool> beforeDue, string searchKey)
        {
            var actionListIdParameter = actionListId.HasValue ?
                new ObjectParameter("ActionListId", actionListId) :
                new ObjectParameter("ActionListId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SSP_GetActionItemsFromActionListId_Result>("SSP_GetActionItemsFromActionListId", actionListIdParameter, onTimeParameter, overDueParameter, beforeDueParameter, searchKeyParameter);
        }

jQuery.namespace('EMPMGMT.User.ViewUserProfile');
...
EMPMGMT.User.ViewUserProfile.pageLoad = function () {
    viewModelUserProfile = new EMPMGMT.User.ViewUserProfile.pageViewModel();
...
//*************************** End ********************************//
EMPMGMT.User.ViewUserProfile.userProfileViewModel = function (user) {
    var self = this;
...
EMPMGMT.User.ViewUserProfile.pageViewModel = function () {
    //Class variables
    var self = this;
    ...
    self.ResetPasswordScreen = function () {
        ...
        self.ConfirmPassword('');
        self.NewPassword('');
        self.pswerrors.showAllMessages(false);
    }
